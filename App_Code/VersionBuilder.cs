...
public class VersionBuilder
{
	...
	public static void SendVersionAlarm()
	{
		...
		SendAlarm(string.Format("\U0000D83D\U0000DCE2<a href='{3}versionchanges.aspx'>{0}</a> has been setup.{1}List of changes:{1}{2}{1}The build will be started as soon as possible.", version, Environment.NewLine, details, Settings.CurrentSettings.GLOBALSITEURL));
	}
}