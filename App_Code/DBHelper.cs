...
public class DBHelper
{
	...
	private static string g_connString = GetConnectionString();
	private static string GetConnectionString()
	{
		string res = "Provider=SQLOLEDB;Initial Catalog=TASKS;Integrated Security = SSPI;";
		if (System.Diagnostics.Debugger.IsAttached)
		{
			return "Data Source = 192.168.0.1;" + res;
		}
		return "Data Source = (local);" + res;
	}
