			...
			<div class="col-lg-8">
				<div ng-show="!searchMachine && !hasMachine()">
					<ul class="list-group list-group-flush">
						<li ng-repeat="c in categories" class="list-group-item">
							<h6>{{c}}</h6>
							<div class="d-flex flex-wrap button-server">
								<div ng-show="m.CATEGORY.toUpperCase() == c" title="{{m.DETAILS}}" data-toggle="tooltip" ng-style="m | mcol:this" ng-click="setMachine(m)" class="m-2 card text-center" style="width: 9em" ng-repeat="m in machines | orderBy : 'PCNAMENAME'">
									<div>
				...
				<div ng-show="hasMachine()">
					...
					<button ng-click="catMachine()" type='button' class='btn btn-block btn-primary btn-lg' id='cate'>Category</button>
